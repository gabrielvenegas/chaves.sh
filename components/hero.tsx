...
export function Hero() {
  return (
    <section className="pt-28 pb-20 px-6 font-mono" style={{ backgroundColor: "#1d2021" }}>
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center gap-8">
        ...
        <p
          ...
          style={{ color: "#928374" }}
        >
          Chaves watches your files, tracks your diffs, and proactively suggests what to work on
          next — without you asking. Like a rubber duck that actually talks back.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3">
          <a
            ...
            onMouseEnter={(e) => ((e.currentTarget as HTMLElement).style.backgroundColor = "#d5d930")}
            onMouseLeave={(e) => ((e.currentTarget as HTMLElement).style.backgroundColor = "#b8bb26")}
          >
            $ get started free
          </a>
          <a
            ...
            style={{ borderColor: "#3c3836", color: "#928374", backgroundColor: "transparent" }}
            onMouseEnter={(e) => {
